...
const translations: Record<Locale, Record<string, any>> = {
  fr: {
    ...
    sidebar: {
      ...
      deleteBrandConfirm: '"{{name}}" sera définitivement supprimée. Cette action est irréversible.',
      refresh: 'Actualiser',
      refreshBrandPro: 'Passez à Pro pour actualiser votre marque',
    },
    status: {
      analyzingBrand: 'Nous analysons votre identité...',
      loadingBrand: 'Chargement de la marque...',
      creating: '✨ Création en cours, veuillez patienter',
    ...
    toast: {
      ...
      brandSavedSuccess: 'Marque sauvegardée !',
      ...
      errorGenerating: 'Erreur pendant la génération',
      ...
      newVisualReady: 'Nouveau visuel prêt !',
      styleAdded: 'Style ajouté',
    ...
    playground: {
      urlStep: {
        ...
        letsStartWith: 'Commençons par',
        yourBrand: 'votre marque.',
        mainWebsite: 'Site principal *',
        additionalSources: 'Sources additionnelles',
        socialNetwork1: 'Réseau social 1',
        socialNetwork2: 'Réseau social 2',
        otherLinks: 'Autres liens (presse, notion, drive...)',
        enrichAfterAnalysis: 'Vous pourrez enrichir ces sources après l\'analyse.',
      ...
      logo: {
        ...
        noLogoYet: 'Je n\'ai pas de logo pour l\'instant →',
      },
      header: {
        createVisuals: 'Créez vos visuels',
      },
      content: {
        contentIdeas: 'Idées de contenu',
        brandVisuals: 'Visuels de la marque',
        logoAlwaysIncluded: 'Logo (toujours inclus)',
        clickToDeselect: 'Cliquez pour désélectionner',
    ...
    settings: {
      ...
      active: 'Actif',
      upgradeToProMore: 'Passez à Pro pour plus de visuels',
    ...
    recentVisuals: {
      title: 'Visuels récents',
      new: 'NOUVEAU',
      manageVisuals: 'Gérer mes visuels',
  ...
  en: {
    ...
    status: {
      ...
      creating: '✨ Creating your visual, please wait',
    ...
    playground: {
      ...
      logo: {
        ...
        thatsIt: 'That\'s it',
        noLogoYet: 'I don\'t have a logo yet →',
      },
      header: {
