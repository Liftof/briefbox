  ...
  fr: {
    ...
    playground: {
      ...
      gallery: {
        ...
        editModeLabel: '✏️ Mode édition directe',
    ...
    projects: {
      ...
      generationsPlural: 'générations',
      folders: 'dossier',
      foldersPlural: 'dossiers',
      favorites: 'favori',
      favoritesPlural: 'favoris',
      myGenerations: 'Mes générations',
      visuals: 'visuel',
      ...
      cancel: 'Annuler',
      delete: 'Supprimer',
      emptyFolders: 'Créez des dossiers pour organiser vos visuels',
      dragDrop: 'Glissez-déposez les images dans les dossiers',
      noGenerations: 'Aucune génération pour l\'instant',
      createFirst: 'Créez votre premier visuel dans l\'espace Créer',
  ...
  en: {
    ...
    playground: {
      ...
      gallery: {
        ...
        editMode: 'Edit mode',
        editModeLabel: '✏️ Direct edit mode',
